...
class my_factory1 implements AbstractFactory
{
    public function createProductA(): AbstractProductA
    {
...
class my_factory2 implements AbstractFactory
{
    public function createProductA(): AbstractProductA
    {
...
interface AbstractProductB
{
    ...
    public function anotherFunctionB(AbstractProductA $collaborator) : string;
}
...
class AbstractProductA1 implements AbstractProductA
{
    public function functionA(): string
    {
        // TODO: Implement functionA() method.
...
class AbstractProductB1 implements AbstractProductB
{
    ...
    public function anotherFunctionB(AbstractProductA $collaborator): string
    {
        // TODO: Implement anotherFunctionB() method.
...
function clientCode(AbstractFactory $factory)
{
    ...
    echo $productB->functionB() . "\n";
    echo $productB->anotherFunctionB($productA) . "\n";
}
...
clientCode(new my_factory1());

echo "\n";

echo "Client: Testing the same client code with the second factory type:\n";
clientCode(new my_factory2());